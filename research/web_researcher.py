...
===================================================================
Uses yfinance for financial data and Mistral web search for qualitative context.
"""
...
def _mistral_web_search(query: str) -> str:
    if not LLM_API_KEY:
        return ""
    try:
...
def research_company(ticker: str, company_name: str, sector: str) -> Dict:
    ...
    for template in SEARCH_TEMPLATES:
        ...
        result = _mistral_web_search(query)
    ...
    if LLM_API_KEY:
        sources.append("mistral-web-search")
