...
def add_observation(ticker: str, company: str, obs_type: str, headline: str, severity: str, supporting_data: str = "", regime_relevance: str = "") -> int:
    reject_keywords = ["stress test", "test data", "sample", "placeholder", "seed"]
    observation_text = f"{headline} {supporting_data}"
    if any(keyword in observation_text.lower() for keyword in reject_keywords): return -1  # Skip insertion
